...
from get_ids.reader.reader import (
    _filter_queries_equal_to_none,
...
class TestReader:
    ...
    def test_ut_get_queries_from_input_file_should_return_a_list_of_lines(self):
        ...
        with patch("get_ids.reader.reader.codecs.open", mock):
            assert _get_queries_from_input_file(self.mock_path_to_file) == ["Reasons to Live - Amy Hempl"]
    ...
    def test_ut_is_query_equal_to_none_present_in_queries_should_return_true_where_query_query_equal_to_none_is_present(
        ...
        assert _is_query_equal_to_none_present_in_queries(self.queries_with_none) is True

    def test_ut_is_query_equal_to_none_should_return_false_where_query_is_not_none(
        self,
    ):
        assert _is_query_equal_to_none_present_in_queries(self.queries_without_none) is False

    def test_ut_filter_queries_equal_to_none_should_remove_queries_equal_to_none(self):
        assert _filter_queries_equal_to_none(self.queries_with_none) == self.queries_without_none
