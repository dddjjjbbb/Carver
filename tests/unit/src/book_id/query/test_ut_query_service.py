...
class TestQueryService:
    ...
    def test_is_subtitle_in_book_title_should_return_true_where_a_colon_subtitle_is_in_the_book_title(
        ...
        assert query_service._is_subtitle_in_book_title(self.book_title_with_colon_subtitle) is True
    ...
    def test_is_subtitle_in_book_title_should_return_true_where_a_semi_colon_subtitle_is_in_the_book_title(
        ...
        assert query_service._is_subtitle_in_book_title(self.book_title_with_semi_colon_subtitle) is True
    ...
    def test_is_subtitle_in_book_title_should_return_true_where_a_parenthesis_subtitle_is_in_the_book_title(
        ...
        assert query_service._is_subtitle_in_book_title(self.book_title_with_parenthesis_subtitle) is True
    ...
    def test_is_subtitle_in_book_title_should_return_false_where_no_subtitle_is_in_the_book_title(
        ...
        assert query_service._is_subtitle_in_book_title(self.book_title_without_subtitle) is False

    def test_is_subtitle_in_book_title_should_return_false_where_book_title_is_a_false_positive(
        self,
    ):
        query_service = QueryService(self.book_title_with_parenthesis_subtitle_false_positive)

        assert query_service._is_subtitle_in_book_title(self.book_title_with_parenthesis_subtitle_false_positive) is False
    ...
    def test_remove_subtitle_from_book_title_should_remove_a_colon_subtitle_if_in_the_book_title(
        ...
        assert query_service._remove_subtitle_from_book_title(self.book_title_with_colon_subtitle) == "An Individual Note"
    ...
    def test_remove_subtitle_from_book_title_should_remove_a_semi_colon_subtitle_if_in_the_book_title(
        ...
        assert (
            query_service._remove_subtitle_from_book_title(self.book_title_with_semi_colon_subtitle)
    ...
    def test_remove_subtitle_from_book_title_should_remove_a_parenthesis_subtitle_if_in_the_book_title(
        ...
        assert query_service._remove_subtitle_from_book_title(self.book_title_with_parenthesis_subtitle) == "Palace Walk"
    ...
    def test_build_search_url_from_query_should_return_encoded_query_where_query_is_not_none(
        ...
        assert query_service._build_search_url_from_query(self.book_title_with_parenthesis_subtitle_false_positive) == result
