...
from tests.unit.src.list.data.all_the_pretty_horses import all_the_pretty_horses_lists_soup
...
class TestListService:
    ...
    def test_get_paginated_list_urls(self):
        ...
        assert self.list_service._get_paginated_list_urls(all_the_pretty_horses_lists_soup, url) == expected
