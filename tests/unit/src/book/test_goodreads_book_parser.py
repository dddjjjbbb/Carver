...
class TestBookService:
    ...
    def test_get_numeric_book_id_where_no_decimal_is_present(self):
        assert (
            self.goodreads_book_parser.get_numeric_id(self.book_id_title_without_decimal)
            == 13079982
        )
    ...
    def test_get_isbn(self):
        assert self.goodreads_book_parser.get_isbn() == int("0330510932")
    ...
    def test_get_isbn13(self):
        assert self.goodreads_book_parser.get_isbn13() == 9780330510936
    ...
    def test_get_lists_url(self):
        assert (
            self.goodreads_book_parser.get_lists_url()
            == "https://www.goodreads.com/list/book/469571"
        )
    ...
    def test_get_number_of_reviews(self):
        assert self.goodreads_book_parser.get_number_of_reviews() == 6587
    ...
    def test_get_number_of_ratings(self):
        assert self.goodreads_book_parser.get_number_of_ratings() == 99515
    ...
    def test_get_average_rating(self):
        assert self.goodreads_book_parser.get_average_rating() == 4.00
