...
<<<<<<< HEAD
=======
    print(f"AUTHOR FULL NAME IS: {author_full_name}")
>>>>>>> b2ba7b2 (migrate to new machine)
...
=======
    ...
    # book_model = BookModel(
    #     author_first_name=book_service.get_author_first_name(str(author_full_name))
    #     if config_author_first_name is True and author_full_name is not None else None,
    #
    # author_full_name=author_full_name,
    #
    # author_last_name=book_service.get_author_last_name(author_full_name)
    #
    # if config_author_last_name is True and author_full_name is not None
    #
    # else None,
    #
    # author_country_of_citizenship=author_model.country_of_citizenship
    #
    # if config_author_last_name is True and author_model is not None
    #
    # else None,
    #
    # average_rating=book_service.get_average_rating()
    ...
    # else None,
    #
    # author_gender=author_model.gender if config_author_gender is True and author_model is not None
    #
    # else None,
    #
    # century_of_publication=book_service.get_century_of_publication(
    ...
    # genres=book_service.get_genres() if config_genres is True else None,
    #
    # goodreads_url=book_service.construct_goodreads_url(book_id_title) if config_goodreads_url is True else None,
    #
    # isbn13=book_service.get_isbn13() if config_isbn13 is True else None,
    #
    # isbn=book_service.get_isbn() if config_isbn is True else None,
    #
    # lists=lists_service.get_lists() if config_lists is True and lists_service is not None else None,
    #
    # number_of_pages=book_service.get_number_of_pages()
    #
    # if config_number_of_pages is True
